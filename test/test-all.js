...
describe('GET /api/render', () => {
  it('request must have "url" query parameter', () => request(app).get('/api/render').expect(400)
  );

  it('invalid cert should cause an error', () => request(app)
    .get('/api/render')
    .query({
  ...
  it('invalid cert should not cause an error when ignoreHttpsErrors=true', () => request(app)
    .get('/api/render')
    .query({
      url: 'https://self-signed.badssl.com/',
...
describe('POST /api/render', () => {
  it('body must have "url" attribute', () => request(app)
    .post('/api/render')
    .send({
      pdf: { scale: 2 },
    })
  ...
  it('render github.com should succeed', () => request(app)
    .post('/api/render')
  ...
  it('html in json body should succeed', () => request(app)
    .post('/api/render')
  ...
  it('html as text body should succeed', () => request(app)
    .post('/api/render')
  ...
  it('rendering large html should succeed', () => request(app)
    .post('/api/render')
  ...
  it('rendering html with large linked images should succeed', () => request(app)
    .post('/api/render')
  ...
  // Skipped: html-kit.com/tools/cookietester is dead. Re-enable once we point
  // this at a live cookie-echo endpoint we control.
  it.skip('cookies should exist on the page', () => request(app)
    .post('/api/render')
    .send({
  ...
  it('special characters should be rendered correctly', () => request(app)
    .post('/api/render')
